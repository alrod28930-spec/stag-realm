-- Analyst 2.0 Database Schema

-- Vectorized knowledge base for RAG (global or workspace-scoped)
-- Adding to existing kb_docs structure
ALTER TABLE kb_docs ADD COLUMN IF NOT EXISTS workspace_scope UUID REFERENCES public.workspaces(id) ON DELETE CASCADE;
